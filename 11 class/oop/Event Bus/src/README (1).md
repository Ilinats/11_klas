...
import org.elsys.oop.eventbus.events.Event;
import org.elsys.oop.eventbus.exception.exception.MissingSubscriptionException;
...
public interface EventBus {
     ...
     * @throws IllegalArgumentException     if the event type is null
     * @throws IllegalArgumentException     if the subscriber is null
     * @throws exception.MissingSubscriptionException if the subscriber is not subscribed to the event type
     */
    <T extends Event<?>> void unsubscribe(Class<T> eventType, Subscriber<? super T> subscriber)
        throws exception.MissingSubscriptionException;
...
└── org.elsys.oop.eventbus
    ...
    │      └── (...)
    ├── exception
    │      └── exception.MissingSubscriptionException.java
    ├── subscribers
